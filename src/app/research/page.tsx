...
export default function ResearchPage() {
  ...
  return (
    <div className="flex flex-col w-full bg-white text-[#111827] overflow-x-hidden">
      ...
      {/* 9. CUSTOM WATERMARK RESEARCH FOOTER matching input_file_6.png */}
      <footer className="bg-white text-[#111827] relative overflow-hidden py-16 sm:py-24 px-4 sm:px-6 lg:px-8 w-full border-t border-gray-100">
        {/* Giant Watermark Background */}
        <div className="absolute inset-0 flex items-center justify-center pointer-events-none select-none overflow-hidden opacity-[0.035] sm:opacity-[0.04] text-[13vw] font-serif font-bold text-gray-900 tracking-tighter leading-none whitespace-nowrap z-0">
          CIS JODHPUR
        </div>
        ...
        <div className="max-w-7xl mx-auto relative z-10">
          <div className="grid grid-cols-1 md:grid-cols-12 gap-12 lg:gap-16">
            ...
            <div className="md:col-span-5 lg:col-span-4 space-y-4">
              ...
              <p className="text-xs sm:text-sm leading-relaxed text-gray-500 max-w-sm">
                A research-intensive institution dedicated to solving complex global problems through technology and social innovation.
              </p>
              <div className="pt-4 text-xs text-gray-400">
                © 2024 CIS Jodhpur Research Division. All rights reserved.
              </div>
            </div>

            {/* Right Columns: EXPLORE, STUDENT LIFE, COMMUNITY, CONTACT */}
            <div className="md:col-span-7 lg:col-span-8 grid grid-cols-2 sm:grid-cols-4 gap-8">
              ...
              <div className="space-y-4">
                ...
                <ul className="space-y-2.5 text-xs sm:text-sm text-gray-400">
                  <li><Link href="#focus-areas" className="hover:text-[#2563EB] transition-colors">Research Areas</Link></li>
                  <li><Link href="#centers" className="hover:text-[#2563EB] transition-colors">Centers & Labs</Link></li>
              ...
              <div className="space-y-4">
                ...
                <ul className="space-y-2.5 text-xs sm:text-sm text-gray-400">
                  <li><Link href="/admissions" className="hover:text-[#2563EB] transition-colors">Admissions Portal</Link></li>
                  <li><Link href="/scholarships" className="hover:text-[#2563EB] transition-colors">Scholarships & Aid</Link></li>
          ...
          {/* Bottom Right Links */}
          <div className="mt-16 pt-8 border-t border-gray-100 flex flex-col sm:flex-row items-center justify-end gap-6 text-xs text-gray-400 font-normal">
            <Link href="#" className="hover:text-[#2563EB] transition-colors">Privacy Policy</Link>
            <Link href="#" className="hover:text-[#2563EB] transition-colors">Ethical Standards</Link>
            <Link href="#" className="hover:text-[#2563EB] transition-colors">Accessibility</Link>
          </div>
        </div>
      </footer>
