...
export default function CampusLifePage() {
  return (
    <div className="min-h-screen bg-white text-[#111827] flex flex-col font-sans selection:bg-[#2563EB]/10 selection:text-[#2563EB]">
      ...
      {/* 11. Custom Footer matching input_file_2.png */}
      <footer className="bg-white border-t border-gray-100 text-[#111827] pt-16 sm:pt-20 pb-8 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto w-full relative overflow-hidden">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 sm:gap-16 relative z-10">
          
          <div className="lg:col-span-5 space-y-4">
            <h3 className="font-serif text-2xl text-[#1E293B] font-normal tracking-tight">
              CIS Jodhpur
            </h3>
            <p className="text-xs sm:text-sm text-gray-400 max-w-sm leading-relaxed font-normal">
              A sanctuary of learning, inquiry, and active leadership in Rajasthan. Developing innovators for tomorrow.
            </p>
          </div>
          ...
          <div className="lg:col-span-7 grid grid-cols-2 sm:grid-cols-4 gap-8">
            <div className="space-y-4">
              ...
              <ul className="space-y-2.5 text-xs sm:text-sm text-gray-400 font-normal">
                <li><a href="#clubs" className="hover:text-[#2563EB] transition-colors">Societies & Clubs</a></li>
                <li><a href="#residences" className="hover:text-[#2563EB] transition-colors">Residences</a></li>
                <li><a href="#overview" className="hover:text-[#2563EB] transition-colors">Athletics Hub</a></li>
                <li><a href="#governance" className="hover:text-[#2563EB] transition-colors">Senate Governance</a></li>
            ...
            <div className="space-y-4">
              ...
              <ul className="space-y-2.5 text-xs sm:text-sm text-gray-400 font-normal">
                <li><Link href="/admissions" className="hover:text-[#2563EB] transition-colors">Apply Now</Link></li>
                <li><Link href="/apply" className="hover:text-[#2563EB] transition-colors">Online Portal</Link></li>
                <li><Link href="/scholarships" className="hover:text-[#2563EB] transition-colors">Scholarships</Link></li>
                <li><Link href="/contact" className="hover:text-[#2563EB] transition-colors">Campus Visit</Link></li>
                <li><Link href="/programs" className="hover:text-[#2563EB] transition-colors">Prospectus</Link></li>
            ...
            <div className="space-y-4">
              ...
              <ul className="space-y-2.5 text-xs sm:text-sm text-gray-400 font-normal">
                <li><Link href="/academics" className="hover:text-[#2563EB] transition-colors">Academics</Link></li>
                ...
                <li><Link href="/faculty" className="hover:text-[#2563EB] transition-colors">Faculty Directory</Link></li>
            ...
            <div className="space-y-4">
              ...
              <ul className="space-y-2.5 text-xs sm:text-sm text-gray-400 font-normal">
                <li><span>NH-65, Jodhpur, RJ</span></li>
                <li><a href="mailto:life@cisjodhpur.edu.in" className="hover:text-[#2563EB] transition-colors">life@cisjodhpur.edu.in</a></li>
                <li><a href="tel:+912912940000" className="hover:text-[#2563EB] transition-colors">+91 291 2940000</a></li>
              </ul>
            </div>
          </div>
        ...
        {/* Massive Watermark */}
        <div className="py-12 sm:py-16 select-none pointer-events-none relative z-0">
          <span className="font-serif text-7xl sm:text-9xl lg:text-[11rem] font-bold text-gray-100/60 tracking-widest block text-center leading-none">
            CIS JODHPUR
          </span>
        </div>

        {/* Bottom bar */}
        <div className="pt-8 border-t border-gray-100 flex flex-col sm:flex-row items-center justify-between gap-4 text-xs text-gray-400 font-normal relative z-10">
          <div>
            &copy; 2025 CIS Jodhpur University. All rights reserved.
          </div>
