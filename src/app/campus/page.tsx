...
export default function CampusPage() {
  ...
  return (
    <div className="min-h-screen bg-white text-[#0F172A] selection:bg-[#2563EB] selection:text-white font-sans overflow-x-hidden">
      ...
      {/* 7. PORTAL & CUSTOM FOOTER matching uploaded_media_3_1784224377491.png + user customization */}
      <footer className="bg-[#EFF6FF] border-t border-[#BFDBFE] pt-16 pb-12">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 md:grid-cols-12 gap-10 pb-12 border-b border-[#BFDBFE]/80">
            
            {/* Left Brand Area matching exact uploaded_media_3 */}
            <div className="md:col-span-4 space-y-4">
              <Link href="/" className="flex items-center gap-3">
                <div className="w-10 h-10 bg-[#2563EB] text-white flex items-center justify-center font-serif text-xl font-bold shadow-sm">
                  C
                </div>
              ...
              <p className="text-sm text-[#475569] max-w-sm leading-relaxed font-normal">
                An international learning community dedicated to academic excellence, personal integrity, and global citizenship.
              </p>
            </div>

            {/* CAMPUS Column matching uploaded_media_3 */}
            <div className="md:col-span-2 space-y-4">
              <h4 className="text-xs font-bold uppercase tracking-widest text-[#2563EB] font-mono">
                CAMPUS
              </h4>
              <ul className="space-y-2.5 text-sm text-[#475569]">
                <li><Link href="/facilities" className="hover:text-[#2563EB] transition-colors">Library</Link></li>
                <li><Link href="/campus#facilities" className="hover:text-[#2563EB] transition-colors">Sports</Link></li>
                <li><Link href="/campus#residences" className="hover:text-[#2563EB] transition-colors">Hostels</Link></li>
                <li><Link href="/campus#facilities" className="hover:text-[#2563EB] transition-colors">Dining</Link></li>
                <li><Link href="/facilities" className="hover:text-[#2563EB] transition-colors">Laboratories</Link></li>
              </ul>
            </div>

            {/* ADMISSIONS Column matching uploaded_media_3 */}
            <div className="md:col-span-2 space-y-4">
              <h4 className="text-xs font-bold uppercase tracking-widest text-[#2563EB] font-mono">
                ADMISSIONS
              </h4>
              <ul className="space-y-2.5 text-sm text-[#475569]">
                <li><Link href="/resources" className="hover:text-[#2563EB] transition-colors">Fees</Link></li>
                <li><Link href="/admissions" className="hover:text-[#2563EB] transition-colors">Process</Link></li>
                <li><Link href="/scholarships" className="hover:text-[#2563EB] transition-colors">Scholarships</Link></li>
                <li><Link href="/contact" className="hover:text-[#2563EB] transition-colors">Visits</Link></li>
                <li><Link href="/faq" className="hover:text-[#2563EB] transition-colors">FAQ</Link></li>
              </ul>
            </div>

            {/* ACADEMICS Column matching uploaded_media_3 */}
            <div className="md:col-span-2 space-y-4">
              <h4 className="text-xs font-bold uppercase tracking-widest text-[#2563EB] font-mono">
                ACADEMICS
              </h4>
              <ul className="space-y-2.5 text-sm text-[#475569]">
                <li><Link href="/programs" className="hover:text-[#2563EB] transition-colors">Curriculum</Link></li>
                <li><Link href="/faculty" className="hover:text-[#2563EB] transition-colors">Faculty</Link></li>
                <li><Link href="/events" className="hover:text-[#2563EB] transition-colors">Events</Link></li>
                <li><Link href="/events" className="hover:text-[#2563EB] transition-colors">Calendar</Link></li>
                <li><Link href="/academics" className="hover:text-[#2563EB] transition-colors">LMS</Link></li>
              </ul>
            </div>

            {/* STUDENT LIFE & LEGAL (Customization) */}
            <div className="md:col-span-2 space-y-4">
              <h4 className="text-xs font-bold uppercase tracking-widest text-[#2563EB] font-mono">
                STUDENT LIFE &amp; LEGAL
              </h4>
              <ul className="space-y-2.5 text-sm text-[#475569]">
                <li><Link href="/campus-life" className="hover:text-[#2563EB] transition-colors font-semibold text-gray-800">Campus Life</Link></li>
                <li><Link href="/gallery" className="hover:text-[#2563EB] transition-colors font-semibold text-[#2563EB]">Visual Gallery</Link></li>
                <li><Link href="/privacy" className="hover:text-[#2563EB] transition-colors">Privacy</Link></li>
                <li><Link href="/terms" className="hover:text-[#2563EB] transition-colors">Terms</Link></li>
                <li><Link href="/accreditation" className="hover:text-[#2563EB] transition-colors">Accreditation</Link></li>
              </ul>
            </div>

          </div>

          {/* Bottom Bar matching exact string from uploaded_media_3 */}
          <div className="pt-8 flex flex-col sm:flex-row items-center justify-between text-xs text-[#64748B] gap-4">
            <p>© 2024 Cambridge International School Jodhpur. Member of CIE Global.</p>
            <div className="flex items-center gap-6 font-medium text-[#475569]">
