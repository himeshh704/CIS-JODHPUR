...
export default function ScholarshipPage() {
  ...
  return (
    <div className="min-h-screen bg-[#F8FAFC] text-[#0F172A] selection:bg-[#2563EB] selection:text-white font-sans flex flex-col">
      ...
      {/* 9. PORTAL SPECIFIC FOOTER (Image 2) */}
      <footer className="bg-[#EFF6FF] border-t border-[#BFDBFE] pt-16 pb-12">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 md:grid-cols-12 gap-12 pb-12 border-b border-[#BFDBFE]/80">
            {/* Left Brand Area */}
            <div className="md:col-span-5 space-y-4">
              <Link href="/" className="flex items-center gap-3">
                <div className="w-10 h-10 bg-white border-2 border-[#1E3A8A] text-[#1E3A8A] flex items-center justify-center font-serif text-xl font-bold shadow-sm">
                  C
                </div>
              ...
              <p className="text-sm text-[#64748B] max-w-sm leading-relaxed">
                Preserving history, building excellence, and engineering future-proof leaders.
              </p>
            </div>

            {/* STUDENT LIFE & ARCHIVES */}
            <div className="md:col-span-2 space-y-4">
              <h4 className="text-xs font-bold uppercase tracking-widest text-[#2563EB]">
                STUDENT LIFE
              </h4>
            ...
            <div className="md:col-span-2 space-y-4">
              ...
              <ul className="space-y-2.5 text-sm text-[#475569]">
                <li>
                  <Link href="/admissions" className="hover:text-[#2563EB] transition-colors">
                    Entrance Exams
                  </Link>
                </li>
                <li>
                  <Link href="/resources" className="hover:text-[#2563EB] transition-colors">
                    Tuition &amp; Fees
                  </Link>
                </li>
                <li>
                  <Link href="/apply" className="hover:text-[#2563EB] transition-colors">
                    Apply Online
                  </Link>
                </li>
                <li>
                  <Link href="/programs" className="hover:text-[#2563EB] transition-colors">
                    CIS Syllabus
                  </Link>
                </li>
              </ul>
            ...
            <div className="md:col-span-3 space-y-4">
              ...
              <ul className="space-y-2.5 text-sm text-[#475569]">
                <li className="flex items-center gap-2">
                  ...
                  <span>scholarships@cisjodhpur.edu</span>
                </li>
                <li className="flex items-center gap-2">
                  <Phone className="w-4 h-4 text-[#2563EB]" />
                  <span>+91 291 274892</span>
                </li>
                <li className="flex items-center gap-2">
                  <MapPin className="w-4 h-4 text-[#2563EB]" />
                  <span>Mehrangarh Road, Jodhpur</span>
                </li>
              </ul>
            </div>
          </div>
          ...
          <div className="pt-8 flex flex-col sm:flex-row items-center justify-between text-xs text-[#64748B] gap-4">
            <p>© 2025 CIS Jodhpur. All institutional rights reserved.</p>
            <div className="flex items-center gap-6">
              <Link href="/privacy" className="hover:text-[#0F172A] transition-colors">
                Privacy Policy
              </Link>
              <span>|</span>
              <Link href="/charter" className="hover:text-[#0F172A] transition-colors">
                Anti-Discrimination Charter
              </Link>
              <span>|</span>
              <Link href="/policies" className="hover:text-[#0F172A] transition-colors">
                Fee Refund Policies
              </Link>
            </div>
          </div>
